...
<div id = "filescroll">
    ...
    <div class = "scrolls file">scrolls/board.txt</div>
    <div class = "scrolls file">scrolls/arduinocode.txt</div>
    <div class = "scrolls file">scrolls/artbox.txt</div>
    <div class = "scrolls file">scrolls/coils.txt</div>
    <div class = "scrolls file">scrolls/mechanicaloscillator.txt</div>
    <div class = "scrolls file">scrolls/hapticmath.txt</div>
</div>
