...
<body>
    ...
    <a href = "linkeditor.php" id = "imagelink">linkeditor.php</a>
...
<div id = "filescroll">
    ...
    <div class = "html file">html/toc.txt</div>
    <div class = "html file">html/carddeck.txt</div>
    <div class = "html file">html/opticalpickup.txt</div>
    <div class = "html file">html/samtec.txt</div>
    <div class = "html file">html/dualhbridge.txt</div>
    <div class = "html file">html/arduino.txt</div>
    <div class = "html file">html/usb.txt</div>
    <div class = "html file">html/pennyconnector.txt</div>
    <div class = "html file">html/stepper.txt</div>
    <div class = "html file">html/hbridge.txt</div>
    <div class = "html file">html/xystage.txt</div>
    <div class = "html file">html/xycables.txt</div>
    <div class = "html file">html/turtle.txt</div>
